...
@dataclass(order=False)  # Desactivamos el orden automático para personalizarlo abajo
class Order:
    order_id: str
    customer_id: str
...
items_user_1 = [{"name": "Laptop", "price": 1000.0, "qty": 1}, {"name": "Mouse", "price": 50.0, "qty": 2}]
items_user_2 = [{"name": "Smartphone", "price": 600.0, "qty": 1}]
items_user_3 = [{"name": "Tablet", "price": 300.0, "qty": 1}, {"name": "Headphones", "price": 80.0, "qty": 1}]
...
print(f"Pedido 1 - Subtotal: ${order_1.subtotal} | Total con impuesto: ${order_1.total}")
print(f"Pedido 2 - Subtotal: ${order_2.subtotal} | Total con impuesto: ${order_2.total}")
print(f"Pedido 3 - Subtotal: ${order_3.subtotal} | Total con impuesto: ${order_3.total}")
